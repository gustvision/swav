...
parser.add_argument(
    "--pretrained", default="", type=str, help="path to pretrained weights"
)
parser.add_argument(
    "--global_pooling",
    default=True,
...
parser.add_argument(
    "--lr", default=0.3, type=float, help="initial learning rate"
)
parser.add_argument("--wd", default=1e-6, type=float, help="weight decay")
parser.add_argument(
    "--nesterov", default=False, type=bool_flag, help="nesterov momentum"
)
parser.add_argument(
    "--scheduler_type", default="cosine", type=str, choices=["step", "cosine"]
)
...
def main():
    ...
    linear_classifier = RegLog(
        1000, args.arch, args.global_pooling, args.use_bn
    )
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        scores = train(
            model, linear_classifier, optimizer, train_loader, epoch
        )
...
class RegLog(nn.Module):
    ...
    def __init__(
        self, num_labels, arch="resnet50", global_avg=False, use_bn=True
    ):

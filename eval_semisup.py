...
parser = argparse.ArgumentParser(
    description="Evaluate models: Fine-tuning with 1% or 10% labels on ImageNet"
)
...
parser.add_argument(
    "--lr", default=0.01, type=float, help="initial learning rate - trunk"
)
parser.add_argument(
    "--lr_last_layer",
    default=0.2,
    type=float,
    help="initial learning rate - head",
)
parser.add_argument(
    "--decay_epochs",
    type=int,
...
def main():
    ...
    logger.info(
        "Building data done with {} images loaded.".format(len(train_dataset))
    )
